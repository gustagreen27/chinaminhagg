...
<head>
    <?php $title = "Configurações de mensagem rolante em home";
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Mensagem do anúncio na home page</h4>
                            </div>
                                ...
                                <form method="POST" action="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="card mb-4">
                                                <div class="card-body">
                                                    <h5 class="card-title"><i class="iconoir-sound-high"></i> Texto</h5>
                                                    <input name="marquee" class="form-control"
