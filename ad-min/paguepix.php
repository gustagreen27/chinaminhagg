...
{
    global $mysqli;
    $qry = "SELECT * FROM paguepix WHERE id=1";
...
{
    global $mysqli;
    $qry = $mysqli->prepare("UPDATE paguepix SET 
        url = ?, 
        client_id = ?,
        client_secret = ?
        WHERE id = 1");
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Gerenciamento de Credenciais (PaguePix)</h4>
                            </div>
                                ...
                                <form method="POST" action="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="card mb-4">
                                                <div class="card-body">
                                                    <h5 class="card-title"><i class="iconoir-group"></i> Client ID
                                                    </h5>
